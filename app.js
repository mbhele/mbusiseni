...
const ContactForm = require('./models/ContactForm'); // Adjust the path as necessary to where you>const multer = require('multer');
...
const upload = multer();
const app = express();
const port = 3009; // Set port directly here
...
app.use(session({ secret: process.env.SESSION_SECRET, resave: false, saveUninitialized: false }));app.use(passport.initialize());
